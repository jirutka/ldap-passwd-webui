...
It’s built with https://pypi.python.org/pypi/bottle/[Bottle], a WSGI micro web-framework for Python.
...
* Python 3.x
* https://pypi.python.org/pypi/bottle/[bottle] >= 0.12.8
* https://pypi.python.org/pypi/ldap3[ldap3] >= 0.9
